...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("FirstZimbabweCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("FirstZimbabweCoin-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("FirstZimbabweCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "FirstZimbabweCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("FirstZimbabweCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("FirstZimbabweCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("FirstZimbabweCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("FirstZimbabweCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. FirstZimbabweCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("FirstZimbabweCoin-start");
