#############################################################################
# Makefile for building: Czecoin-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: pá 25. 7 16:00:18 2014
# Project:  Czecoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.5\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile Czecoin-qt.pro
#############################################################################
...
Makefile: Czecoin-qt.pro  ../Qt/4.8.5/mkspecs/default/qmake.conf ../Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile Czecoin-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/Czecoin/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/Czecoin/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/Czecoin/src/leveldb/libleveldb.a: FORCE
	cd C:/Czecoin/src/leveldb && CC=gcc CXX=g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-fpermissive -O2" libleveldb.a libmemenv.a && ranlib C:/Czecoin/src/leveldb/libleveldb.a && ranlib C:/Czecoin/src/leveldb/libmemenv.a
